...
async function liveDataHandler(request, response) {
...
async function sourceScanHandler(request, response) {
...
export default async function handler(request, response) {
  if (request.query.action === "source-scan") return sourceScanHandler(request, response);
  return liveDataHandler(request, response);
}
